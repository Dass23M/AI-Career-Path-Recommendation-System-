  ...
  <svg viewBox="0 0 360 280" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    {[
      ...
      <g key={i}>
        ...
        <text x={node.cx} y={node.cy + 44} textAnchor="middle" fill="#aaa" fontSize="7" fontFamily="monospace" letterSpacing="0.5">{node.sub}</text>
      </g>
    ))}
  </svg>
);
  ...
  return (
    <>
      ...
      <div style={{ background: "#f5f0e8", color: "#0a0a0a", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
        ...
        {/* ══ HERO ══════════════════════════════════════ */}
        <section className="max-w-7xl mx-auto px-6 pt-32 pb-20 relative overflow-hidden">
          <div className="absolute inset-0 ruled-bg opacity-40 pointer-events-none"/>
          <div className="absolute -top-10 -left-10 font-bold text-[20vw] leading-none opacity-[0.04] select-none pointer-events-none" style={{ fontFamily: "'Playfair Display', serif", color: "#0a0a0a" }}>
            WHO
          </div>
          ...
          <div className="relative grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <motion.h1
                ...
                style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 900, fontSize: "clamp(2.8rem, 5.5vw, 5rem)", color: "#0a0a0a", lineHeight: 1.05, marginTop: "1.25rem", marginBottom: "1.25rem" }}
              >
                We Help People<br />
            ...
            >
              ...
              <div className="relative border-2 bg-white p-6" style={{ borderColor: "#0a0a0a" }}>
                <div className="h-64"><MissionIllustration /></div>
              </div>
              <div className="absolute -bottom-5 -right-5 px-4 py-2" style={{ background: "#0a0a0a" }}>
        ...
        <section style={{ background: "#0a0a0a" }} className="py-14">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 divide-x divide-white/10">
            {stats.map(({ num, label }, i) => (
              ...
              >
                <div style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "3rem", color: "#c8b89a" }}>{num}</div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-28">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(2rem, 4vw, 3.5rem)", color: "#0a0a0a", lineHeight: 1.1, marginTop: "0.75rem" }}>
            ...
            >
              <div className="absolute inset-0 -translate-x-4 translate-y-4 border-2" style={{ borderColor: "#c8b89a" }}/>
              <div className="relative border-2 bg-white p-6" style={{ borderColor: "#0a0a0a" }}>
                <div className="h-64"><TechIllustration /></div>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section style={{ background: "#0a0a0a" }} className="py-24">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(2rem, 4vw, 3.5rem)", color: "#f5f0e8", lineHeight: 1.1, marginTop: "0.75rem" }}>
            ...
            <div className="grid md:grid-cols-2 gap-px" style={{ background: "#222" }}>
              {values.map((v, i) => (
                ...
                >
                  <div style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "4rem", color: "#c8b89a", opacity: 0.25, lineHeight: 1, marginBottom: "0.5rem" }}>{v.index}</div>
                  <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.4rem", color: "#f5f0e8", marginBottom: "0.75rem" }}>{v.title}</h3>
        ...
        <section className="max-w-7xl mx-auto px-6 py-28">
          <div className="grid md:grid-cols-2 gap-20 items-start">
            ...
            >
              <div className="absolute inset-0 translate-x-4 translate-y-4 border-2" style={{ borderColor: "#c8b89a" }}/>
              <div className="relative border-2 bg-white p-6" style={{ borderColor: "#0a0a0a" }}>
                <div className="h-64"><TeamIllustration /></div>
              </div>
            ...
            <div>
              ...
              >
                ...
                <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(2rem, 4vw, 3rem)", color: "#0a0a0a", lineHeight: 1.1, marginTop: "0.75rem" }}>
              ...
              <div className="space-y-4">
                {team.map((member, i) => (
                  <motion.div
                    ...
                    transition={{ delay: i * 0.1 }}
                    whileHover={{ x: 6 }}
                    className="flex items-center gap-5 p-5 border-2 transition-all"
                    style={{ borderColor: "#0a0a0a", background: "white" }}
                  >
                    <div className="w-12 h-12 flex items-center justify-center font-bold text-sm shrink-0"
                    ...
                    <div>
                      ...
                      <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.65rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "#9e8a6e", marginTop: "0.15rem" }}>{member.role}</p>
                    </div>
                    <div className="ml-auto" style={{ color: "#d4cabc" }}>
              ...
              {[
                ...
                >
                  ...
                  <div className="pt-2 pb-8 border-b" style={{ borderColor: "#d4cabc", flex: 1 }}>
                    <h3 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "1.25rem", color: "#0a0a0a" }}>{item.title}</h3>
        ...
        {/* ══ CTA ═══════════════════════════════════════ */}
        <section style={{ background: "#0a0a0a" }} className="py-28 relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
            <span style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "22vw", color: "#f5f0e8", opacity: 0.03, lineHeight: 1 }}>JOIN</span>
          </div>
          <div className="relative max-w-3xl mx-auto px-6 text-center">
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 900, fontSize: "clamp(2.2rem, 5vw, 4rem)", color: "#f5f0e8", lineHeight: 1.1, marginTop: "1rem", marginBottom: "1.5rem" }}>
              Start Your Career<br /><span style={{ fontStyle: "italic", color: "#c8b89a" }}>Journey Today.</span>
            </h2>
            <p style={{ fontWeight: 300, color: "#666", lineHeight: 1.8, maxWidth: "40ch", margin: "0 auto 3rem" }}>
              Join thousands of students who found their direction with CareerAI.
            </p>
            <div className="flex justify-center gap-5 flex-wrap">
              <Link href="/prediction"
                className="px-8 py-4 transition-all"
                style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", letterSpacing: "0.14em", textTransform: "uppercase", background: "#c8b89a", color: "#0a0a0a", border: "2px solid #c8b89a" }}
              ...
              <Link href="/register"
                className="px-8 py-4 transition-all"
                style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", letterSpacing: "0.14em", textTransform: "uppercase", background: "transparent", color: "#f5f0e8", border: "2px solid #333" }}
